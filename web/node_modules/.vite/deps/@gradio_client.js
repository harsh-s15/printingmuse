...
var st = (e, t, s) => t in e ? tt(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s;
var u = (e, t, s) => st(e, typeof t != "symbol" ? t + "" : t, s);
var $e = (e, t, s) => t.has(e) || Se("Cannot " + s);
var W = (e, t, s) => ($e(e, t, "read from private field"), s ? s.call(e) : t.get(e));
var ke = (e, t, s) => t.has(e) ? Se("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s);
var Re = (e, t, s, n) => ($e(e, t, "write to private field"), n ? n.call(e, s) : t.set(e, s), s);
...
var ct = "sleeptime";
var lt = "heartbeat";
var ut = "component_server";
var pt = "reset";
var ft = "cancel";
var ht = "app_id";
var dt = "https://gradio-space-api-fetcher-v2.hf.space/api";
var xe = "This application is currently busy. Please try again. ";
var H = "Connection errored out. ";
var z = "Could not resolve app config. ";
var _t = "Could not get space status. ";
var mt = "Could not get API info. ";
var _e = "Space metadata could not be loaded. ";
var gt = "Invalid URL. A full URL path is required.";
var wt = "Not authorized to access this space. ";
var Ie = "Invalid credentials. Could not login. ";
var yt = "Login credentials are required to access this space.";
var bt = "File system access is only available in Node.js environments";
var Ue = "Root URL not found in client config";
var vt = "Error uploading file";
function Et(e, t, s) {
...
var jt = typeof process < "u" && process.versions && process.versions.node;
function De(e, t, s) {
  for (; s.length > 1; ) {
    const i = s.shift();
...
async function zt(e, t, s) {
  ...
  try {
    ...
    if (typeof process < "u" && process.versions && process.versions.node) {
      const g = await import("./__vite-browser-external-DYxpcVy9-TYBWYDTX.js");
      l = (await import("./__vite-browser-external-DYxpcVy9-TYBWYDTX.js")).resolve(process.cwd(), n.meta.path), a = await g.readFile(l);
    } else
      throw new Error(bt);
...
var Gt = /^(?=[^]*\b[dD]iscussions{0,1}\b)(?=[^]*\b[dD]isabled\b)[^]*$/;
async function Ce(e) {
  try {
    const t = await fetch(
...
var I;
var Vt = class extends TransformStream {
...
function Zt(e) {
  let t = new TextDecoderStream(), s = new Vt({ allowCR: true });
...
function is(e, t = {}, s, n, i) {
  ...
  try {
    ...
    let V, S = null, D = false, ce = {}, G = typeof window < "u" && typeof document < "u" ? new URLSearchParams(window.location.search).toString() : "";
              ...
              let Ee = async function(ue) {
                try {
                  ...
                  console.error("Unexpected client exception", L), o({
                    ...
                    fn_index: f,
                    time: /* @__PURE__ */ new Date()
                  }), ["sse_v2", "sse_v2.1", "sse_v3"].includes(j) && (ge(ne, We.abort_controller), ne.open = false, a());
                }
              };
...
var ee = class {
  constructor(t, s = { events: ["data"] }) {
    ...
    u(this, "last_status", {});
    u(this, "cookies", null);
    u(this, "stream_status", { open: false });
    u(this, "closed", false);
